...
namespace MediaGallery.DataAccess
{
	...
	{
		private const string ERROR_MESSAGE = "Could not recognise image format.";
		...
		public static Size GetDimensions(string path)
		{
			using (BinaryReader binaryReader = new BinaryReader(File.OpenRead(path)))
			{
				...
				{
					if (ex.Message.StartsWith(ERROR_MESSAGE))
						throw new ArgumentException(ERROR_MESSAGE, "path", ex);
